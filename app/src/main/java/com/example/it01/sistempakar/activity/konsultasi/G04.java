...
public class G04 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g04);
        ButterKnife.bind(this);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Pertanyaan 4");
        ...
        if(sharedPreferences.contains("G04")){
            int data = sharedPreferences.getInt("G04", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G04.this);
    ...
    public void lanjut(){
        ...
        editor.commit();
        startActivity(new Intent(this, G05.class));
    }
