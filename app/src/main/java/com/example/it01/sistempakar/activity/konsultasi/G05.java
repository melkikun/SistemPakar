...
public class G05 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g05);
        ButterKnife.bind(this);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Pertanyaan 5");
        ...
        if(sharedPreferences.contains("G05")){
            int data = sharedPreferences.getInt("G05", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G05.this);
    ...
    public void lanjut(){
        ...
        editor.commit();
        startActivity(new Intent(this, G06.class));
    }
