...
public class G07 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Pertanyaan 7");
        ...
        if(sharedPreferences.contains("G07")){
            int data = sharedPreferences.getInt("G07", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G07.this);
    ...
    public void lanjut(){
        ...
        editor.commit();
        startActivity(new Intent(this, G08.class));
    }
