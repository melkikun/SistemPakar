...
public class G09 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Pertanyaan 9");
        ...
        if(sharedPreferences.contains("G09")){
            int data = sharedPreferences.getInt("G09", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G09.this);
    ...
    public void lanjut(){
        ...
        editor.commit();
        startActivity(new Intent(this, G10.class));
    }
