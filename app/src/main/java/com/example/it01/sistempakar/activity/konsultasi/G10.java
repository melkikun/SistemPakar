...
public class G10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Pertanyaan 10");
        ...
        if(sharedPreferences.contains("G10")){
            int data = sharedPreferences.getInt("G10", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G10.this);
    ...
    public void kembali(){
        ...
        editor.commit();
        startActivity(new Intent(this, G09.class));
    }
