...
public class G13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Pertanyaan 13");
        ...
        if(sharedPreferences.contains("G13")){
            int data = sharedPreferences.getInt("G13", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G13.this);
    ...
    public void kembali(){
        ...
        editor.commit();
        startActivity(new Intent(this, G12.class));
    }
