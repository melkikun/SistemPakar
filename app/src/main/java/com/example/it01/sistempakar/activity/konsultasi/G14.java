...
public class G14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Pertanyaan 14");
        ...
        if(sharedPreferences.contains("G14")){
            int data = sharedPreferences.getInt("G14", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G14.this);
    ...
    public void lanjut(){
        ...
        editor.commit();
        startActivity(new Intent(this, G15.class));
    }
