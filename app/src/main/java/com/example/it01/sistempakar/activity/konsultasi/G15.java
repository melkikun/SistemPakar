...
public class G15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g15);
        ButterKnife.bind(this);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Pertanyaan 15");
        ...
        if(sharedPreferences.contains("G15")){
            int data = sharedPreferences.getInt("G15", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G15.this);
    ...
    public void lanjut(){
        ...
        editor.commit();
        startActivity(new Intent(this, G16.class));
    }
    ...
    public void kembali(){
        ...
        editor.commit();
        startActivity(new Intent(this, G14.class));
    }
