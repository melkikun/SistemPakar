...
public class G18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Pertanyaan 18");
        ...
        if(sharedPreferences.contains("G18")){
            int data = sharedPreferences.getInt("G18", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G18.this);
