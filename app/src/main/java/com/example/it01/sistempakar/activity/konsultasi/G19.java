...
public class G19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g19);
        ButterKnife.bind(this);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Pertanyaan 19");
        ...
        if(sharedPreferences.contains("G19")){
            int data = sharedPreferences.getInt("G19", 0);
            if(data == 1){
                ya.setChecked(true);
            }else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                finish();
            case R.id.utama:
                AlertDialog.Builder builder = new AlertDialog.Builder(G19.this);
    ...
    public void lanjut(){
        ...
        editor.commit();
        startActivity(new Intent(this, G20.class));
    }
